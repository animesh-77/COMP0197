...
if __name__ == "__main__":
    ...
    images, labels = next(
        dataiter
    )  # note: for pytorch versions (<1.14) use dataiter.next()
    ...
    im.save("tutorials/img_cls/train_pt_images.jpg")
    ...
    # save trained model
    torch.save(net.state_dict(), "tutorials/img_cls/saved_model.pt")
    print("Model saved.")
